  ...
  return (
    <div ref={ref} className={classes.classShortViewTeacher}>
      <div className={classes.topBar}>
        <i>
          {" "}
          <span className={classes.classNo}> 1 </span> CLASS ID: 2122432{" "}
        </i>
        ...
        <span>
          <span>
            {" "}
            <BsPeopleFill className={classes.participantIcon} />{" "}
            <span className={classes.numParticipant}>37 </span>{" "}
          </span>
      ...
      <div className={classes.topicsBar}>
        <i>
          TOPICS: Wave functions, uncertainty principle ,Wave functions
          functions, uncertainty principle ,Wave functions functions,
